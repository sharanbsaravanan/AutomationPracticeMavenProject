...
public class chromeSignUp {
    ...
    public static void signup(int i) throws InterruptedException {
        System.setProperty("webdriver.chrome.driver", "D://Selenium//chromedriver//chromedriver.exe");
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//body/section[@id='form']/div[1]/div[1]/div[3]/div[1]/form[1]/input[3]")).sendKeys("sharan1beta"+i+"@gmail.com");
        Thread.sleep(2000);
